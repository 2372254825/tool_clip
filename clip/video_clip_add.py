    ...
    for item in find_special_files(root, patterns=['*.txt'], exclude_dirs=[], exclude_patterns=['*_keyframe.txt'],
        ...
        if item_info_dict != {}:
            for frame_info in read_frame_info(item):
                ...
                clip_name = os.path.join(os.path.dirname(target_row_path), face_dict[frame_info[2]], os.path.basename(target_row_path) + "_{}_{}_{}_{}.avi".format(frame_info[0], frame_info[1], frame_info[2], face_dict[frame_info[2]]))
                # clip_name = os.path.join(root, os.path.basename(target_row_path) + "_{}_{}_{}_{}.avi".format(frame_info[0], frame_info[1], frame_info[2], face_dict[frame_info[2]]))
...
if __name__ == '__main__':
    root = r"\\dtc-fs\SmartCar\DMS_Train\Face_Video_Train_Set\7_had_commited\Face_Video_Train_Set_20200521"
